...
pacman -S --needed --noconfirm \
	...
	mingw-w64-ucrt-x86_64-libsigc++ mingw-w64-ucrt-x86_64-yaml-cpp mingw-w64-ucrt-x86_64-SDL2 \
...
# CPack MSI is automatically generated by the build when WIXPATH is set,
